...
public abstract class GeoportalRequestObject {
	...
	this.imageDisplay = new ImageDisplay(DISPLAY_X_COORDINATE,
		DISPLAY_Y_COORDINATE, DISPLAY_RESOLUTION);
	...
	@Override
	public int hashCode() {
	    return new HashCodeBuilder().append(getX()).append(getY())
		    .append(getWkid()).hashCode();
	}
	...
	public boolean equals(Object obj) {
	    ...
	    return new EqualsBuilder().append(getX(), other.getX())
		    .append(getY(), other.getY())
	...
	public int hashCode() {
	    ...
	    return new HashCodeBuilder().append(getXmax()).append(getYmax())
		    .append(getXmin()).append(getYmin())
	...
	public boolean equals(Object obj) {
	    ...
	    return new EqualsBuilder().append(getXmax(), other.getXmax())
		    .append(getYmax(), other.getYmax())
		    .append(getXmin(), other.getXmin())
		    .append(getYmin(), other.getYmin())
		    .append(getSpatialReference(), other.getSpatialReference())
		    .isEquals();
	...
	public boolean equals(Object obj) {
	    ...
	    return new EqualsBuilder().append(getWkid(), other.getWkid())
		    .isEquals();
	}
	...
	public String toString() {
	    return String.format("%s,%s,%s", getWidth(), getHeight(),
		    getResolution());
	}

	@Override
	public int hashCode() {
	    return new HashCodeBuilder().append(getWidth()).append(getHeight())
		    .append(getResolution()).hashCode();
	}
	...
	public boolean equals(Object obj) {
	    ...
	    return new EqualsBuilder().append(getHeight(), other.getHeight())
	...
	return new HashCodeBuilder().append(getGeometry())
		.append(getGeometryType()).append(getMapExtent())
		.append(getImageDisplay()).append(getSr())
		.append(isReturnGeometry()).append(getTolerance())
		.append(getLayers()).append(getFormat()).hashCode();
    }
	...
	return new EqualsBuilder().append(getGeometry(), other.getGeometry())
		.append(getGeometryType(), other.getGeometryType())
		.append(getMapExtent(), other.getMapExtent())
		.append(getImageDisplay(), other.getImageDisplay())
		.append(getSr(), other.getSr())
		.append(isReturnGeometry(), other.isReturnGeometry())
		.append(getTolerance(), other.getTolerance())
