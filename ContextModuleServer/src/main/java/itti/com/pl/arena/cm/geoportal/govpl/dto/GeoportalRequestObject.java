...
public abstract class GeoportalRequestObject {
	...
	private static class Geometry{
		...
		public boolean equals(Object obj) {
			...
			return new EqualsBuilder()
				.append(getX(), other.getX())
				.append(getY(), other.getY())
				.append(getWkid(), other.getWkid())
			.isEquals();
		}
	...
	public int hashCode() {
		...
		return new HashCodeBuilder()
			...
			.append(getMapExtent())
			.append(getImageDisplay())
			.append(getSr())
			.append(isReturnGeometry())
			.append(getTolerance())
			.append(getLayers())
			.append(getFormat())
		.hashCode();
