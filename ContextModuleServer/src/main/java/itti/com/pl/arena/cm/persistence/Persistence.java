...
public interface Persistence {
     ...
     * @throws PersistenceException Could not initialize storage
     */
    public void init() throws PersistenceException;

    /**
     * Shutdowns persistence storage
     * @throws PersistenceException Could not shutdown storage
     */
     ...
     * @param location location of the platform
     * @throws PersistenceException Could not store that information in the database
     */
     ...
     * @throws PersistenceException Could not retrieve information from the database
     */
     ...
     * @param platformId ID of the platform
     * @param initialTimestamp initial timestamp, locations saved after that timestamp will be returned
