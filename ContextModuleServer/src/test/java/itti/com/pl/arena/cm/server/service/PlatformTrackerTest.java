...
public class PlatformTrackerTest {
    ...
    public void testCheckPlatformStoppedEmptyDB() throws OntologyException {
        ...
        Mockito.verify(ontology, Mockito.times(0)).getGISObjects(Mockito.anyDouble(), Mockito.anyDouble(), Mockito.anyDouble(),
    ...
    public void testCheckPlatformStoppedPlatformStoppedOutsideArea() throws OntologyException, PersistenceException {
        ...
        Mockito.verify(ontology, Mockito.times(1)).getGISObjects(Mockito.anyDouble(), Mockito.anyDouble(), Mockito.anyDouble(),
                Mockito.any(String[].class));
        // status is 'stopped'
    ...
    public void testCheckPlatformStoppedPlatformStoppedInsideArea() throws OntologyException, PersistenceException {
        ...
        Mockito.verify(ontology, Mockito.times(Range.values().length)).getGISObjects(Mockito.anyDouble(), Mockito.anyDouble(),
                Mockito.anyDouble(), Mockito.any(String[].class));
        // listener was notified about platform move
        Mockito.verify(listener, Mockito.times(1)).destinationReached(Mockito.anyString(), Mockito.any(Location.class));
        // status is 'stopped'
