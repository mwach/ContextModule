...
public class ContextModuleJmsServiceTest {
    ...
    @Test
    @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "NP_NULL_PARAM_DEREF", justification = "Intentionally testing code can handle null value")
    ...
    public void testGetPlatformNeighborhoodProperValueRequest() throws JsonHelperException, OntologyException {
        ...
        Mockito.when(ontology.getPlatformNeighborhood(Mockito.anyString())).thenReturn(coordinates);
        CMJmsService.setOntology(ontology);
    ...
    public void testGetListOfPlatformsRequest() throws OntologyException {
        ...
        // prepare dummy ontology
        Ontology ontology = Mockito.mock(Ontology.class);
        Mockito.when(ontology.getInstances(OntologyConstants.Vehicle_with_cameras.name())).thenReturn(
