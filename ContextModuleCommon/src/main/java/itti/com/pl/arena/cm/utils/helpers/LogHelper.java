...
public final class LogHelper {
	...
	private static void initLogger() {
		try {
			...
			System.out.println(String.format("Could not initialize logger: %s",
	 ...
	 *            exception
	 */
	public static void exception(Class<?> clazz, String method, String message,
			Throwable throwable) {
	 ...
	 *            optional message arguments
	 */
	public static void warning(Class<?> clazz, String method, String msg,
			Object... args) {
	 ...
	 *            optional message arguments
	 */
	public static void info(Class<?> clazz, String method, String msg,
			Object... args) {
	 ...
	 *            optional message arguments
	 */
	public static void debug(Class<?> clazz, String method, String msg,
			Object... args) {
	 ...
	 *            optional message arguments
	 */
	private static void log(Class<?> clazz, Level level, boolean exception,
			String method, String message, Object... args) {
		...
		if (logger.isLoggable(level)) {
			...
			String formattedMessage = String.format("[%s:%s][Thread:%d] %s",
					clazz.getName(), method, threadId, message);
