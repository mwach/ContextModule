...
public final class PropertiesHelper {
	...
	public static Properties loadProperties(String fileName)
		...
		if (!StringHelper.hasContent(fileName)) {
			throw new IOHelperException(
					ErrorMessages.PROPERTIES_HELPER_NO_FILE_PROVIDED);
		}
		...
		try {
			...
			throw new IOHelperException(exc,
					ErrorMessages.PROPERTIES_HELPER_COULD_NOT_PARSE, fileName,
	 ...
	 * @throws IOHelperException
	 */
	public static Map<String, String> loadPropertiesAsMap(
			String propertiesFileName) throws IOHelperException {
		...
		for (Entry<Object, Object> entry : props.entrySet()) {
			propsAsMap.put(
					...
					entry.getValue() == null ? null : String.valueOf(entry
							.getValue()));
		}
		return propsAsMap;
	}
	...
	public static int getPropertyAsInteger(Properties properties,
		...
		// get the property value
		Integer value = NumbersHelper.getIntegerFromString(properties
	...
	public static boolean getPropertyAsBoolean(Properties properties,
		...
		if (StringHelper.equalsIgnoreCase(value, Boolean.TRUE.toString())) {
			return true;
		} else if (StringHelper.equalsIgnoreCase(value,
