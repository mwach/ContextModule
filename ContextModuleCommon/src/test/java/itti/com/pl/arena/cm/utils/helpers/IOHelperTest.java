...
public class IOHelperTest {
    ...
    public void testReadStreamBinaryData() throws IOHelperException {
        ...
        int[] lengthsToCheck = new int[] { 0, 1, 12, 16, 32, 33, 64, 65, 512, 1024, 1025, 3343, random.nextInt(100000),
    ...
    public void testReadStreamStringData() throws IOHelperException {
        ...
        String[] stringsToCheck = new String[] { "", "some text", UUID.randomUUID().toString(), getDummyString(64),
                getDummyString(1024), getDummyString(1300) };
