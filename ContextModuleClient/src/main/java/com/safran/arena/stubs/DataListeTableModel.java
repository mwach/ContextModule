...
/**
 * This model fills a table with a data list. This is clearly not optimized for adding/removing data, it is build for a
 * data set that changed fully between two updates.<bR>
 * This model is not a listener, as other models could be, because it is filled by the result of a request and not by
 * events.
 * 
 * @author F270116
 * 
