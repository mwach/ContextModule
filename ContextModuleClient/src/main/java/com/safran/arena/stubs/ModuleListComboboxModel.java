...
/**
 * This model feeds a ComboBox with the known modules' list. This implements the ConfigurationManagerInterface to get
 * the module registering events. But, this is not a Module. It is a listener for events dispatched by ModuleImpl. <br>
 * BUG: will not display a data producer which has been registered before its initialization but has not distributed
 * data before this module's query to the repository.
 * 
 * @author F270116
 * 
 */
@SuppressWarnings("rawtypes")
public class ModuleListComboboxModel extends AbstractListModel implements ComboBoxModel, ConfigurationManagerInterface {
     ...
     * (non-Javadoc)
     * 
     * @see com.safran.arena.ConfigurationManagerInterface#onModuleUnregistered(eu .arena_fp7._1.Module)
     */
    @Override
    ...
    public void setSelectedItem(Object arg0) {
        if (arg0 instanceof String) {
            ...
            IllegalArgumentException e = new IllegalArgumentException("Argument should be String, was " + arg0);
            e.printStackTrace();
            throw e;
        }
