...
public class UtilIntrospection {
    ...
    /**
     * Cette m�thode permet de lister toutes les classes d'un package donn�. This method lists all classes from a given
     * package. source :
     * http://www.developpez.net/forums/d168275/java/general-java/recuperer-liste-classes-package-resolu/
     * 
     * @param pckgname
     *            Le nom du package � lister
    ...
    /**
     * Cette m�thode retourne la liste des classes pr�sentes dans un r�pertoire du classpath et dans un package donn�
     * 
     * @param repertoire
     *            Le r�pertoire o� chercher les classes
     * @param pckgname
     *            Le nom du package
     * @return La liste des classes
     */
