...
/**
 * This model is used to fill a table with a list of events (i.e.: {@link AbstractDataFusionType}
 * creation/modification/suppression). Current version is minimalist. <br>
 * This implements DataConsumerInterface and is to be registered to ModuleImpl to get the events.
 * 
 * @author F270116
 * 
 */
public class EventListTableModel extends AbstractTableModel implements DataConsumerInterface {
    ...
    @Override
    public void onDataAvailable(Class<? extends AbstractDataFusionType> dataType, String dataSourceId, AbstractDataFusionType data) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void onDataDeleted(Class<? extends AbstractDataFusionType> dataType, String dataSourceId, AbstractDataFusionType data) {
        // TODO Auto-generated method stub
