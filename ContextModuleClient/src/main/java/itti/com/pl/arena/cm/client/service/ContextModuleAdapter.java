...
public class ContextModuleAdapter {
    ...
    public List<String> getListOfParkingLots() {
        SimpleNamedValue request = contextModule.createSimpleNamedValue(moduleName, null);
    ...
    public List<String> getListOfZones(String parkingLot) {
        SimpleNamedValue request = contextModule.createSimpleNamedValue(moduleName, parkingLot);
